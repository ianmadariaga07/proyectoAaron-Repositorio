...
//iniciar juego, descripción , historia completa, datos del alumno, salir del juego. agregar menu principal
//optimizar, hacer mas eficiente
...
int main(){
    ...
    cout<<"Bienvenido, te acaban de elegir como presidente de una potencia mundial, te encuentras en una situación delicada, con la amenaza inminente de una tercera guerra "<<endl<<"mundial. La tensión con otras potencias está en su punto maximo, y cada una de tus decisiones podría tener consecuencias cruciales. El mundo está observando y "<<endl<<"esperando, con la esperanza de que puedas encontrar una solución pacífica para evitar el desastre."<<endl<<endl;
    ...
    do{
        ...
        if(respuesta == 'N'){
            cout<<"En la guerra, el camino seguro lleva a la destrucción. Oculta tus fortalezas, haz valer tus debilidades. Venga, toma el poder"<<endl<<endl;
        }else if(respuesta !='N'){
    ...
    cout<<"---------------------------------------"<<endl;
    //ACTO UNO
    cout<<"La mañana comienza con una reunión urgente en la Casa Blanca. Tu equipo de asesores te presenta informes detallados sobre la situación actual: disputas territoriales,conflictos ideológicos y desacuerdos comerciales que han llevado a un estado de tensión global. Todos están ansiosos por saber cómo planeas abordar la crisis y "<<endl<<"evitar una escalada hacia la guerra."<<endl<<endl;
    //DECISION UNO
    ...
    do{
        ...
        cout<<"5. Renunciar a la presidencia(SALIR DEL JUEGO)"<<endl;
    ...
    switch(decision){
        ...
        case 4: 
            ...
            break;
        case 5: 
            cout<<"Renunciando a la presidencia..."<<endl<<endl;
            exit(0);
    }
    ...
    cout<<"---------------------------------------"<<endl;
    //ACTO DOS
    cout<<"El mundo observa con atención mientras te embarcas en intensas negociaciones. Las conversaciones son difíciles y llenas de desafíos, pero demuestras habilidad "<<endl<<"diplomática y empatía para encontrar soluciones aceptables para todas las partes. Trabajas incansablemente para construir puentes de entendimiento y compromiso, "<<endl<<"buscando soluciones a los problemas subyacentes que han llevado al mundo al borde del abismo."<<endl<<endl;
    //DECISION DOS
    cout<<"----Estado actual de la Paz Mundial: "<<pazMundial<<"%----"<<endl<<endl;

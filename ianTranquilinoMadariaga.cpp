...
//PENDIENTES
//Ver posibles cambios en la historia

//PONEMOS LAS FUNCIONES PARA QUE EL COMPILADOR LAS RECONOZCA
int aleatorio(int min, int max);
string eleccion(int jugada); //String es un tipo de dato para cadena de caracteres

//INICIAMOS FUNCION PRINCIPAL(OBLIGATORIA)
int main(){
        ...
        switch(decision){
            case 1: //INICIO DEL JUEGO
                ...
                do{
                    ...
                    if(respuesta == 'N' || respuesta == 'n'){ // 'N' y 'n' son correctas
                ...
                }while(respuesta != 'S' && respuesta != 's'); // 'S' y 's' son correctas
                ...
                switch(decision){
                    ...
                    case 4: 
                        ...
                        break;
                    case 5: 
                        cout<<"Ahora alguien mas tomara el cargo. Has quedado en deuda con la nacion, que patetico..."<<endl<<endl;
                ...
                do{
                    ...
                    if(decision>2 || decision<1){
                        cout<<endl<<"Respuesta no valida. Intente de nuevo..."<<endl<<endl;
                    }
                ...
                switch(decision){
                    case 1:
                        decision = -1;
                        cout<<endl<<"Estamos regresando al menu principal..."<<endl<<endl;
                        cout<<endl<<"---------------------------------------"<<endl;
                        break;
                    case 2:
                        decision = 1;
                        cout<<endl<<"Saliendo del juego..."<<endl<<endl;
                        break;
                }
            ...
            case 2: //MINIJUEGO
                //Hacer que un numero mal ingresado te de la oportunidad de elegir otra vez
                    ...
                    do{
                        ...
                        if(respuesta == 'N' || respuesta == 'n'){ // 'N' y 'n' son correctas
                            cout<<"La lealtad es un regalo raro que solo se da a aquellos que realmente lo merecen. Venga, no dejes esperando a tu camarada"<<endl<<endl;
                        }else if(respuesta != 'N' && respuesta != 'n' && respuesta != 'S' && respuesta != 's'){
                            cout<<"Respuesta no valida. Intente de nuevo"<<endl<<endl;
                        }
                    }while(respuesta != 'S' && respuesta != 's');  // 'S' y 's' son correctas
...
string eleccion(int jugada){
    ...
    return resultado; //retornamos el resultado para guardarlo en eleccion
}
